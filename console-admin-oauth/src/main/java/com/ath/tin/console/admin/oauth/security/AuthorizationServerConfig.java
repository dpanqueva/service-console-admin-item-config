...
import com.ath.tin.console.admin.oauth.component.GeneralProperties;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory().withClient(prop.findValue("config.security.oauth.client.id"))
                .secret(passwordEncoder.encode(prop.findValue("config.security.oauth.client.secret")))
                .scopes("read", "write")
