package com.ath.tin.configuration.manager.component;
...
@Component
@PropertySource(value = {"file:${PATH_CONFIG_CORE_TIN}/service-console-admin-users-${spring.profiles.active}.properties"}, encoding = "UTF-8")
